...
class LivraisonSelector extends StatefulWidget {
  final Function(int, String?, String?) onFraisChange; // Fonction de rappel
          ...
          DropdownButtonFormField<String>(
            ...
            onChanged: (value) {
              setState(() {
                ...
                selectedQuartier = null; // Reset quartier
                fraisLivraison = 0; // Reset frais
              });
            },
          ),
          SizedBox(height: 16),
            ...
            onChanged: (value) {
              setState(() {
                ...
                fraisLivraison = communes[selectedCommune]!
                    .firstWhere((quartier) =>
                        quartier['name'] == value)['frais'];
                
                // Appel de la fonction callback pour envoyer frais, commune, et quartier
                widget.onFraisChange(
                    fraisLivraison, selectedCommune, selectedQuartier);
              });
            },
          ),
        ],
